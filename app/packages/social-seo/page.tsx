    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-teal-50/30 to-cyan-50/30">
      ...
      <section className="relative w-full bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 py-16 sm:py-20 md:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            badge="Social Media, SEO & GMB Services"
            heading="Complete Digital Marketing Solution"
            description="Get comprehensive social media marketing, full SEO optimization, and Google My Business management in one powerful package. Boost your online presence and drive more customers to your business."
            size="lg"
            align="center"
            as="h1"
